...
class Panel(tk.Tk):
    ...
    def __init__(self):
        ...
        ComboBox1 = ttk.Combobox(self, values=['console', 'windowed'], textvariable=self.ComboBoxVar1,
                                 state='readonly')
        ...
        CheckBox1 = ttk.Checkbutton(self, text='name', variable=self.CheckBoxVar1, onvalue=' --name', offvalue='',
        ...
        CheckBox2 = ttk.Checkbutton(self, text='onefile', variable=self.CheckBoxVar2, onvalue=' --onefile',
                                    offvalue='', command=lambda: self.BuildCommand(''))
        CheckBox2.place(width=69, height=21, x=10, y=159)

        self.CheckBoxVar3 = tk.StringVar()
        self.CheckBoxVar3.set(' --noupx')
        CheckBox3 = ttk.Checkbutton(self, text=('noupx'), variable=self.CheckBoxVar3, onvalue=' --noupx',
                                    offvalue='', command=lambda: self.BuildCommand(''))
        CheckBox3.place(width=66, height=21, x=164, y=159)

        self.CheckBoxVar4 = tk.StringVar()
        self.CheckBoxVar4.set('')
        CheckBox4 = ttk.Checkbutton(self, text='version-file', variable=self.CheckBoxVar4,
                                    onvalue=' --version-file', offvalue='', command=lambda: self.BuildCommand(''))
        CheckBox4.place(width=92, height=21, x=10, y=194)

        button5 = ttk.Button(self, text='Browse', command=lambda: self.GetDirectoryString('versionfile'))
        ...
        button7 = ttk.Button(self, text='Browse', command=lambda: self.GetDirectoryString('script'))
        ...
        CheckBox5 = ttk.Checkbutton(self, text='icon', variable=self.CheckBoxVar5, onvalue=' --icon',
                                    offvalue='', command=lambda: self.BuildCommand(''))
        CheckBox5.place(width=56, height=21, x=10, y=264)
        button8 = ttk.Button(self, text='Browse', command=lambda: self.GetDirectoryString('icon'))
    ...
    def BuildCommand(self, event):
        ...
        string = 'pyinstaller --clean ' + combo_temp1 + self.CheckBoxVar2.get() + self.CheckBoxVar3.get()
